...
int message; // OK
int valJoyestickPS4YMin; // OK
int valJoyestickPS4YMax; // OK
int valJoyestickPS4XMin; // OK
int valJoyestickPS4XMax; // OK
...
void loop() {
  ...
  if (PS4.connected()) {
    ...
    // ACCELERATEUR
    valeurAccelerateurs = PS4.getAnalogButton(R2) - PS4.getAnalogButton(L2);
    
    // ANGLE LACET  
    // R1 & L1 -> angle lacet
    if(PS4.getButtonClick(R1) && PS4.getButtonClick(L1)) {
      angleLacet = 0;
    }
    // L1 -> angle lacet
